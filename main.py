# manually define the paths in the shell
'''export EEG_FMRI=/Users/apple/projects/eeg_to_fmri
export EEG_FMRI_DATASETS=/Users/apple/projects/eeg_to_fmri/datasets'''
...
#set seed and configuration of memory (commenting this out for testing)
...
#adding for review
print(f"main.py: Train Data Shapes: {eeg_train.shape, fmri_train.shape}")
